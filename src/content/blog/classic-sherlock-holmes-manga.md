...
<img src="/images/classic-sherlock-holmes-manga.jpg" alt="夜更かし必読 で、名推理の夜を" style="max-width: 100%; height: auto; max-height: 150px; object-fit: contain; border-radius: 8px; border: 1px solid #edf2f7;" loading="lazy" />
</div>
...
<h4 style="margin: 0 0 10px 0; font-size: 1.08rem; font-weight: 700; color: #1a202c; line-height: 1.4;">夜更かし必読 で、名推理の夜を</h4>
